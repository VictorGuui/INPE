...
dset = xr.open_dataset('/mnt/c/INPE/Semana30102023-01112023/Atividade3.2.MalhaComTodasUFsDoBrasil/Chirps1AmericaDoSul1991_2020MediaSazonal.nc')
# print(dset)
...
plt.savefig('s1-MediaSazonal.png', dpi=300)
...
plt.savefig('s2-MediaSazonal.png', dpi=300)
plt.show()
