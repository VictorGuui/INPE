...
dset = xr.open_dataset('/mnt/c/INPE/Semana30102023-01112023/Atividade3.2.MalhaComTodasUFsDoBrasil/Chirps1AmericaDoSul1991_2020MediaAnual.nc')
# print(dset)
...
plt.savefig('s1-MediaAnual.png', dpi=300)
...
plt.savefig('s2-MediaAnual.png', dpi=300)
plt.show()
